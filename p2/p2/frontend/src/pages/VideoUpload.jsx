        ...
        <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <div className="glass rounded-2xl p-6 border border-white/10">
                ...
                <div className="space-y-3">
                  <div>
                    <p className="text-sm font-medium text-gray-300 mb-1">Supported Formats</p>
                    <p className="text-xs text-gray-400">MP4, WebM, MOV, AVI</p>
                  </div>
                  <div>
                    <p className="text-sm font-medium text-gray-300 mb-1">Maximum Size</p>
                    <p className="text-xs text-gray-400">100 MB</p>
                  </div>
                  <div>
                    <p className="text-sm font-medium text-gray-300 mb-1">Recommended Duration</p>
                    <p className="text-xs text-gray-400">2-10 minutes</p>
                  </div>
                  <div>
                    <p className="text-sm font-medium text-gray-300 mb-1">Resolution</p>
                    <p className="text-xs text-gray-400">720p or higher</p>
                  </div>
                </div>
              </div>
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="glass rounded-xl p-6 border border-white/10 hover:border-violet-500/50 transition-all">
